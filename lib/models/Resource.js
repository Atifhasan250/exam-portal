...
const RESOURCE_LANGUAGES = ['bn', 'en', 'mixed', 'other']
...
const ResourceSchema = new mongoose.Schema(
  {
    ...
    slug: { type: String, trim: true, lowercase: true, maxlength: 280, sparse: true, unique: true },
    description: { type: String, trim: true, maxlength: 2000, default: '' },
    url: { type: String, trim: true, maxlength: 1200, default: '' },
    thumbnailUrl: { type: String, trim: true, maxlength: 1200, default: '' },

    youtubeId: { type: String, trim: true, maxlength: 40, sparse: true, unique: true },
...
ResourceSchema.index({ title: 'text', description: 'text', tags: 'text', topicTags: 'text' })
