...
const ResourceQuizQuestionSchema = new mongoose.Schema(
  {
    question: { type: String, required: true, trim: true, maxlength: 5000 },
    options: [{ type: String, required: true, trim: true, maxlength: 1000 }],
    correct: { type: Number, required: true, min: 0 },
    explanation: { type: String, trim: true, maxlength: 5000, default: '' },
...
const ResourceSchema = new mongoose.Schema(
  {
    ...
    quizQuestions: { type: [ResourceQuizQuestionSchema], default: [] },
...
if (
  ...
  (
    ...
    !mongoose.models.Resource.schema.path('quizQuestions')
  )
) {
