...
export const RESOURCE_LANGUAGES = ['bn', 'en', 'mixed', 'other']
...
export function toPublicResource(resource) {
  ...
  return {
    ...
    categoryId: resource.categoryId
      ? {
          _id: resource.categoryId._id,
          name: resource.categoryId.name,
          slug: resource.categoryId.slug,
          icon: resource.categoryId.icon,
          color: resource.categoryId.color,
        }
      : null,
    type: resource.type,
