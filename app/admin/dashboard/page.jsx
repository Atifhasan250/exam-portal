    ...
    <div className="bg-theme-bg min-h-screen text-theme-primary transition-theme">
        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
            <Link href="/" className="shrink-0">
              <Image src="/favicon.png" alt="Logo" width={32} height={32} className="object-contain rounded-xl" />
            </Link>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
            ...
            <button onClick={logout} className="px-3 sm:px-4 py-2 text-sm font-medium bg-theme-error-bg text-theme-error-text border border-theme-error-border rounded-xl hover:opacity-80 transition-all flex items-center">
              <i className="fas fa-sign-out-alt sm:mr-2" />
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button onClick={() => { setShowCreate(true); setEditExam(null) }} className="bg-theme-accent text-white font-bold px-6 py-3 rounded-xl hover:opacity-90 transition-all flex items-center space-x-2 shadow-lg">
